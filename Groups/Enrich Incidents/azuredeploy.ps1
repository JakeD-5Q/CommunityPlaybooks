...
$remoteUrl = "https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Playbooks/Get-AlienVault_OTX/azuredeploy.json"
$localTemplate = 'alienvault.parameters.json'
